...
1. Descarga el `.zip` de la skill que te interesa (link en la tabla de arriba,
   dentro de cada carpeta).
2. Descomprímelo. Vas a obtener una carpeta con un archivo `SKILL.md`.
3. **La forma más simple:** abre ese `SKILL.md`, copia todo el contenido y
   pégalo en tu conversación con Claude o con Codex. Ya queda funcionando,
   sin nada que instalar.
4. **Si usas Claude Code** y quieres que quede disponible como skill
   permanente: copia la carpeta completa dentro de `.claude/skills/` en tu
   proyecto (o en tu carpeta de skills de usuario).

No hace falta cuenta, licencia ni configuración adicional.
